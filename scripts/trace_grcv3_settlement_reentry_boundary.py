"""Trace why only one settlement lane re-enters through split children."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Trace the post-split reentry boundary between two rich.v4 "
...
def main(argv: list[str] | None = None) -> int:
    ...
    trace = build_grcv3_landscape_settlement_reentry_trace(
