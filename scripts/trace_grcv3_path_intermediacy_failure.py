"""Trace the earliest divergence between direct and path-mediated rich.v4 lanes."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Trace the earliest material divergence between direct and "
            "path-mediated rich.v4 transfer-mediation lanes."
        )
    )
    parser.add_argument(
        "--baseline-seed",
        default=str(DEFAULT_GRCV3_PATH_FAILURE_TRACE_BASELINE_SEED),
        help="Baseline direct-lane seed path.",
    )
    parser.add_argument(
        "--comparison-seed",
        default=str(DEFAULT_GRCV3_PATH_FAILURE_TRACE_COMPARISON_SEED),
        help="Comparison path-mediated seed path.",
    )
    parser.add_argument(
        "--profile",
    ...
    parser.add_argument(
        "--steps",
        type=int,
        default=DEFAULT_GRCV3_PATH_FAILURE_TRACE_STEPS,
...
def main(argv: list[str] | None = None) -> int:
    ...
    trace = build_grcv3_landscape_path_failure_trace(
