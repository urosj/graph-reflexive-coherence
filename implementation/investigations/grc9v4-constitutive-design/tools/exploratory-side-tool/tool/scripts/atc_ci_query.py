#!/usr/bin/env python3
"""Read-only scoped A_CI research source, claim and debt queries."""
import argparse
import json
import sys
...
def main():
    ...
    if args.operation == "audit":
        ...
        value = (atc_ci.reconstruction_path if args.operation == "claim" else atc_ci.debt_lifecycle)(
