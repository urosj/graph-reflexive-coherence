...
def main() -> int:
    ...
    gate: dict[str, object] = {
        ...
        "acceptance_requirements": {
            "independent_source_projection_audit": "pending_execution",
            "python_and_node_component_tests": "pending_execution",
            "deterministic_double_rebuild": "pending_execution",
            "playwright_desktop_mobile": "pending_execution",
            "ET_C7_predecessor_regression": "pending_execution",
