...
export async function verifiedParents(value) {
  if (value?.authority_extension_digest !== '3715d198eb15564ea459fcd0fdf9d7f185ddce4800cc9b66c31fed41b3f129a0') throw new Error('Unadmitted parent authority identity');
...
async function loadParents() {
  ...
  try {
    ...
    parentValue = value;
    status.textContent = `Accepted policy: ${value.policy_id}. G2 remains pending.`;
    renderParents();
  } catch (error) {
