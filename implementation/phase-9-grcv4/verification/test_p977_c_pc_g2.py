"""Narrow C_PC facade supplement and read-only integrated-review pressure."""
...
class ReviewTests(unittest.TestCase):
    def test_rehashed_interface_evidence_rejects_missing_or_widened_checks(self):
        import verify_p977_c_pc_g2 as gate
    ...
    def test_integrated_product_and_rehashed_false_proposals(self):
        ...
        edits = {
            ...
            'family_alias': lambda v: v.update(proposed_additional_support=['C_PC']),
