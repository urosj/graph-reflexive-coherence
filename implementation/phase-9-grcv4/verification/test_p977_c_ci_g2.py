"""Narrow C_CI facade supplement and read-only integrated-review pressure."""
...
class ReviewTests(unittest.TestCase):
    def test_integrated_product_and_rehashed_false_proposals(self):
        import verify_p977_c_ci_g2 as gate
        ...
        edits = {
            ...
            'family_alias': lambda v: v.update(proposed_additional_support=['C_CI']),
