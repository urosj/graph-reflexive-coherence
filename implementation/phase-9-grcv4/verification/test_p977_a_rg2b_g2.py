"""Narrow A_RG2b facade supplement and read-only integrated-review pressure."""
...
class InterfaceTests(unittest.TestCase):
    def test_exact_profile_configuration_strict_run_and_missing_defaults(self):
        ...
        config['initial']['current']['W_A'][0] = 999
        config['initial']['reset']['W_A'][0] = 999
        ...
        with self.assertRaisesRegex(TypeError,'A_RG2b requires its differential reference'):
        ...
        self.assertNotEqual(inputs.current.W_A,inputs.reset.W_A)
        ...
        self.__class__.evidence = dict(source_config=source, initial_snapshot=initial,
            ...
            checks=dict(configuration_detached=True, immutable_parameters=True, unchanged_assignment=True,
                ...
                W_configuration_detached=True,reset_W_preserved=True,no_carrier_slot=True,frozen_completion_unchanged=True),
...
class ReviewTests(unittest.TestCase):
    def test_rehashed_interface_evidence_rejects_role_completion_and_scope_drift(self):
        ...
        edits={
            ...
            'mutable_W':lambda v:v['evidence']['checks'].update(W_configuration_detached=False),
            'missing_reset':lambda v:v['evidence']['checks'].pop('reset_W_preserved'),
            ...
            'reset_W':lambda v:v['evidence']['after_stream']['reset']['authoritative'].update(W_A=[2.]*3),
    ...
    def test_integrated_product_and_rehashed_false_proposals(self):
        ...
        edits = {
            ...
            'family_alias': lambda v: v.update(proposed_additional_support=['A_RG2b']),
            ...
            'scalar_as_graph':lambda v:v['ordered_scope'].update(retained_scalar_RG2b_is_not_graph_nomination=False),
            ...
            'event_loss_erased':lambda v:v['ordered_scope'].update(event_policy='lossless_nomination_event'),
