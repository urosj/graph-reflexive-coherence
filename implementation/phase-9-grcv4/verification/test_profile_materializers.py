...
class MaterializerTests(unittest.TestCase):
    ...
    def test_next_gate_text_uses_checked_registry_not_historical_family_literals(self):
        ...
        self.assertIn('Exact accepted G2 declarations (10)',accepted_summary)
        ...
        views['profile_g2']=[r for r in views['profile_g2'] if r['profile_family_id'] not in ('C_CI_PC','A_RG2b','C_RG2b')]
