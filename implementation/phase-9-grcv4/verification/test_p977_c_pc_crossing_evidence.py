"""Rehashed C_PC evidence pressure, without lifecycle campaign reruns."""
...
import verify_p977_c_pc_crossings as crossing
...
class CrossingEvidenceTests(unittest.TestCase):
    def test_rehashed_scope_map_history_and_endpoint_mutations(self):
        ...
        mutations={
            ...
            'borrowed_source':lambda v:row(v,'mapped_event').update(complete_profile_id='C_PC'),
