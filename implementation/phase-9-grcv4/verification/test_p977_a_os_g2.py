"""Narrow A_OS facade supplement and read-only integrated-review pressure."""
...
class InterfaceTests(unittest.TestCase):
    def test_exact_profile_configuration_strict_run_and_missing_defaults(self):
        ...
        self.assertIn(NOMINATED, list_supported_profiles())  # Separate G2 acceptance now publishes this exact ID.
...
class ReviewTests(unittest.TestCase):
    def test_integrated_product_and_rehashed_false_proposals(self):
        import verify_p977_a_os_g2 as gate
        ...
        edits = {
            ...
            'family_alias': lambda v: v.update(proposed_additional_support=['A_OS']),
