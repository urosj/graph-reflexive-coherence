...
CANDIDATE_RUNTIME_METHODS = {
    "authorize_candidate_mechanism",
    "observe_object_flow",
    "record_candidate_mechanism_event",
}
...
class CausalPathwayBindingI121Test(unittest.TestCase):
    ...
    def test_candidate_provider_is_acyclic_and_uses_a_structural_host(self) -> None:
        ...
        self.assertEqual(
            CANDIDATE_RUNTIME_METHODS,
            _class_method_names(CANDIDATES_PATH, "_CandidateRuntime"),
        )
    ...
    def test_candidate_logic_is_absent_from_session_module(self) -> None:
        ...
        self.assertNotIn("AUTHORITY_COORDINATES", session_assignments)
        self.assertNotIn(
            "INVALID_RELABEL_CANDIDATE_REVIEW_TRUST_REQUIREMENT",
            session_assignments,
        )
