...
The current post-Phase-8 handoff moves next to a scoped `N25.2` bridge before
N26. The Phase 8 `LGRC9V3` multi-basin formation tranche now consumes the
closed N25/N25.1 evidence and closes at `MB5`: control-backed native
multi-basin formation candidate evidence is available, while `MB6` and
N26-ready unscoped multi-basin substrate evidence remain blocked.
