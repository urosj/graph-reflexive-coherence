...
The current post-N25 handoff moves next to a Phase 8 `LGRC9V3`
multi-basin-formation implementation tranche. That work should consume the
closed N25/N25.1 evidence and requirements from `experiment-N25`: N25 supports
scoped BF5 high-margin core / sub-basin formation, while N25.1 closes a
requirements bridge for native LGRC9V3 multi-basin formation with runtime
evidence still closed at `MB0`. N26 remains downstream and may consume N25 in
scoped mode unless a future Phase 8 extension reaches `MB6`.
