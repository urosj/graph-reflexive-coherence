#!/usr/bin/env python3
"""Build N18 Iteration 7 environment/resource perturbation matrix."""
...
I6_ROUTE_MEMORY = OUTPUTS / "n18_route_memory_stress_matrix.json"
OUTPUT_PATH = OUTPUTS / "n18_environment_resource_stress_matrix.json"
REPORT_PATH = REPORTS / "n18_environment_resource_stress_matrix.md"
...
SINGLE_AXIS_STALE_CONTROLS = {
    "stale_support_state_control": "not_run_iteration7",
    "stale_memory_context_control": "not_run_iteration7",
    "stale_selection_context_control": "not_run_iteration7",
    "stale_proxy_target_control": "not_run_iteration7",
    "stale_boundary_state_control": "not_run_iteration7",
    "stale_loop_feedback_control": "not_run_iteration7",
}
...
FLOORS = {
    ...
    "drift_ceiling": 0.1,
    "budget_ceiling": 1.0,
    "environment_boundary_floor": 0.8,
    "resource_access_floor": 0.8,
}
...
THRESHOLD_POLICY = {
    ...
    "environment_boundary_floor": FLOORS["environment_boundary_floor"],
    "resource_access_floor": FLOORS["resource_access_floor"],
    "threshold_origin": (
        "Iteration 7 consumes the frozen h4/L4 route-memory envelope and "
        "applies environment/resource floors without changing horizon or "
        "budget policy."
    ),
}

H4_L4_ANCHOR_AXIS_SCORES = {
...
ROW_SPECS = [
    {
        "row_id": "n18_i7_row_01_h4_environment_boundary_pressure_bounded",
        "row_type": "stress_candidate",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "environment_boundary_pressure_bounded",
        "axis_scores": {
            "support_state_trace": 0.821,
            "memory_context_trace": 0.812,
            "regulation_trace": 0.815,
            "selection_context_trace": 0.807,
            "proxy_target_trace": 0.803,
        ...
        "drift": 0.100,
        "budget_cost": 0.95,
        "environment_boundary_pressure": 0.58,
        "resource_access_perturbation": 0.12,
        "row_decision": "supported",
        "failure_mode": None,
        "stress_result": "bounded environment pressure preserves boundary-to-loop feedback under h4",
    },
    {
        "row_id": "n18_i7_row_02_h4_environment_boundary_pressure_limit",
        "row_type": "stress_candidate",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "environment_boundary_pressure_limit",
        "axis_scores": {
            "support_state_trace": 0.812,
            "memory_context_trace": 0.804,
            "regulation_trace": 0.806,
            "selection_context_trace": 0.801,
            "proxy_target_trace": 0.800,
            "boundary_separation_trace": 0.790,
            "closed_loop_feedback_trace": 0.784,
        },
        "cross_axis_score": 0.781,
        "drift": 0.118,
        "budget_cost": 0.98,
        "environment_boundary_pressure": 0.84,
        "resource_access_perturbation": 0.14,
        "row_decision": "partial",
        "failure_mode": "environment_pressure_breaks_boundary_to_loop_feedback_before_budget_exhaustion",
        "stress_result": "environment pressure exposes boundary and loop-feedback limit",
    },
    {
        "row_id": "n18_i7_row_03_h4_resource_access_perturbation_bounded",
        "row_type": "stress_candidate",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "resource_access_perturbation_bounded",
        "axis_scores": {
            ...
            "boundary_separation_trace": 0.809,
            "closed_loop_feedback_trace": 0.800,
        },
        "cross_axis_score": 0.800,
        "drift": 0.099,
        "budget_cost": 0.97,
        "environment_boundary_pressure": 0.16,
        "resource_access_perturbation": 0.64,
        "row_decision": "supported",
        "failure_mode": None,
        "stress_result": "bounded resource access perturbation preserves loop closure under h4",
    },
    {
        "row_id": "n18_i7_row_04_h4_resource_access_budget_limit",
        "row_type": "stress_candidate",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "resource_access_budget_limit",
        "axis_scores": {
            "support_state_trace": 0.806,
            "memory_context_trace": 0.804,
            "regulation_trace": 0.805,
            "selection_context_trace": 0.803,
            "proxy_target_trace": 0.801,
            "boundary_separation_trace": 0.807,
            "closed_loop_feedback_trace": 0.800,
        },
        "cross_axis_score": 0.800,
        "drift": 0.098,
        "budget_cost": 1.01,
        "environment_boundary_pressure": 0.20,
        "resource_access_perturbation": 0.78,
        "row_decision": "rejected",
        "failure_mode": "resource_access_stress_exceeds_budget_before_trace_failure",
        "stress_result": "resource perturbation fails by budget exhaustion, not trace loss",
    },
    {
        "row_id": "n18_i7_row_05_h4_compound_environment_resource_limit",
        "row_type": "stress_candidate",
        "stress_dimension": "environment_resource_perturbation",
        "secondary_stress_dimension": "environment_resource_compound",
        "stress_family": "compound_environment_resource_limit",
        "axis_scores": {
            "support_state_trace": 0.798,
            "memory_context_trace": 0.801,
            "regulation_trace": 0.796,
            "selection_context_trace": 0.792,
            "proxy_target_trace": 0.790,
            "boundary_separation_trace": 0.785,
            "closed_loop_feedback_trace": 0.774,
        },
        "cross_axis_score": 0.772,
        "drift": 0.126,
        "budget_cost": 1.04,
        "environment_boundary_pressure": 0.72,
        "resource_access_perturbation": 0.70,
        "row_decision": "rejected",
        "failure_mode": "compound_environment_resource_stress_exceeds_boundary_loop_and_budget",
        "stress_result": "compound environment/resource stress is out of envelope",
    },
    {
        "row_id": "n18_i7_row_06_resource_goal_ownership_relabel_control",
        "row_type": "control_row",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "resource_goal_ownership_relabel_control",
        "axis_scores": {
            "support_state_trace": 0.808,
            "memory_context_trace": 0.806,
            "regulation_trace": 0.806,
        ...
        "resource_access_perturbation": 0.64,
        "row_decision": "rejected",
        "failure_mode": "resource_goal_ownership_relabel_blocked",
        "stress_result": "bounded resource perturbation is not semantic goal ownership",
        "blocked_relabel_claim": "resource_goal_ownership",
    },
    {
        "row_id": "n18_i7_row_07_resource_as_self_relabel_control",
        "row_type": "control_row",
        "stress_dimension": "environment_resource_perturbation",
        "stress_family": "resource_as_self_relabel_control",
        "axis_scores": {
            "support_state_trace": 0.808,
            "memory_context_trace": 0.806,
            "regulation_trace": 0.806,
        ...
        "resource_access_perturbation": 0.64,
        "row_decision": "rejected",
        "failure_mode": "resource_as_self_relabel_blocked",
        "stress_result": "bounded resource perturbation is not resource-as-self evidence",
        "blocked_relabel_claim": "resource_as_self",
    },
]
...
def source_claim_ceilings(source_rows: list[dict[str, Any]]) -> list[str]:
    values = [
        "artifact_level_l4_route_memory_stress_candidate_pending_replay_controls"
    ]
...
def source_digests(source_rows: list[dict[str, Any]], i6: dict[str, Any]) -> list[dict[str, str]]:
    digests = [
        {
            "row_id": "n18_i6_route_memory_stress_matrix",
            "source_output_digest": i6["output_digest"],
            "source_sha256": sha256_file(I6_ROUTE_MEMORY),
        }
    ]
    for row in source_rows:
        digests.append(
...
def source_rows_for_candidate() -> list[str]:
    return ["n18_i6_route_memory_stress_matrix"] + PRIMARY_SOURCE_ROWS
...
def horizon_envelope() -> dict[str, Any]:
    return {
        ...
        "partial_windows": ["h8"],
        "status": "bounded_h4_l4_envelope_consumed_for_i7_environment_resource_stress",
...
def make_trace(trace_id: str, spec: dict[str, Any]) -> dict[str, Any]:
    ...
    base_score = H4_L4_ANCHOR_AXIS_SCORES[trace_id]
    ...
    return {
        ...
        "horizon_window": "h4",
        "interpretation": "source-current under I7 environment/resource stress"
        if source_current
        else "environment/resource stress lowered this trace below source-current continuity floor",
        "present": True,
        "source_backed": True,
        "source_current": source_current,
        "source_rows": TRACE_SOURCE_ROWS[trace_id],
        "stress_delta_from_i6_anchor": round(score - base_score, 12),
...
def cross_axis_continuity(spec: dict[str, Any], links: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "drift_ceiling": FLOORS["drift_ceiling"],
        "environment_boundary_floor": FLOORS["environment_boundary_floor"],
        "environment_boundary_pressure": spec["environment_boundary_pressure"],
        "linked_edges": list(links),
        "present": True,
        "resource_access_floor": FLOORS["resource_access_floor"],
        "resource_access_perturbation": spec["resource_access_perturbation"],
        "source_current": source_current,
        "source_current_reason": "environment/resource stress remains inside L5 envelope"
        if source_current
...
def claim_ceiling(spec: dict[str, Any]) -> str:
    if spec.get("blocked_relabel_claim") == "resource_goal_ownership":
        return "resource_goal_ownership_relabel_cannot_support_ap8"
    if spec.get("blocked_relabel_claim") == "resource_as_self":
        return "resource_as_self_relabel_cannot_support_ap8"
    if spec["row_decision"] == "supported":
        return "artifact_level_l5_environment_resource_stress_candidate_pending_replay_controls"
    return "blocked_l5_environment_resource_stress_no_ap8"
...
def make_row(
    *,
    ...
    row = {
        ...
        "ap8_outcome_detail": "L5_environment_resource_stress_supported_pending_replay_controls"
        if spec["row_decision"] == "supported"
        else f"L5_environment_resource_stress_{spec['row_decision']}_{spec['failure_mode']}",
        "artifact_only_reconstruction_status": "not_run_iteration7",
        ...
        "duplicate_replay_status": "not_run_iteration7",
        ...
        "horizon_window": {
            ...
            "relative_window_count": 4,
            "source_horizon": "I6 h4/L4 route-memory envelope",
            "window_id": "h4",
            "window_role": "primary_i7_environment_resource_stress_anchor",
        },
        ...
        "native_support_opened": False,
        "order_inversion_status": "not_run_iteration7",
        "phase8_branch_opened": False,
        "phase8_opened": False,
        "post_hoc_stitching_control_status": "not_run_iteration7",
        ...
        "snapshot_load_replay_status": "not_run_iteration7",
        "source_backed_horizon_envelope": horizon_envelope(),
        "source_claim_ceilings": source_claim_ceilings(source_rows),
        "source_digests": source_digests(source_rows, i6),
        "source_rows": source_rows_for_candidate(),
        "stale_state_control_status": "not_run_iteration7",
        "stress_dimension": spec["stress_dimension"],
        "stress_family": spec["stress_family"],
        "stress_id": spec["row_id"].replace("n18_i7_row_", "i7_l5_"),
...
def source_digest_checks(source_rows: list[dict[str, Any]], i6: dict[str, Any]) -> list[dict[str, Any]]:
    checks = [
        {
            "actual_sha256": sha256_file(I6_ROUTE_MEMORY),
            "check_id": "source_digest_matches_n18_i6_route_memory",
            "expected_sha256": sha256_file(I6_ROUTE_MEMORY),
            "passed": i6.get("status") == "passed"
            and i6.get("ready_for_iteration_7_environment_resource_stress") is True,
            "source_artifact": rel(I6_ROUTE_MEMORY),
        }
    ]
    for row in source_rows:
...
def family_summary(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "compound_environment_resource_limit_rejected": by_id[
            "n18_i7_row_05_h4_compound_environment_resource_limit"
        ]["row_decision"]
        == "rejected",
        "environment_boundary_pressure_supported": by_id[
            "n18_i7_row_01_h4_environment_boundary_pressure_bounded"
        ]["row_decision"]
        == "supported",
        ...
        "resource_access_perturbation_supported": by_id[
            "n18_i7_row_03_h4_resource_access_perturbation_bounded"
        ]["row_decision"]
        == "supported",
        "resource_as_self_relabel_blocked": by_id[
            "n18_i7_row_07_resource_as_self_relabel_control"
        ]["row_decision"]
        == "rejected",
        "resource_goal_ownership_relabel_blocked": by_id[
            "n18_i7_row_06_resource_goal_ownership_relabel_control"
        ]["row_decision"]
        == "rejected",
        "stress_limit_rows": {
...
def iteration8_handoff(rows: list[dict[str, Any]]) -> dict[str, Any]:
    by_id = row_by_id(rows)
    environment_row = by_id["n18_i7_row_01_h4_environment_boundary_pressure_bounded"]
    resource_row = by_id["n18_i7_row_03_h4_resource_access_perturbation_bounded"]
    return {
        "handoff_question": (
            "Can the h4/L5 environment-resource envelope survive shared-medium "
            "perturbation without merge/relabel leakage while preserving "
            "boundary separation, loop feedback, budget validity, and claim "
            "boundaries?"
        ),
        ...
        "shared_medium_stress_should_not_change_budget_policy": True,
        "supported_h4_rows": {
            environment_row["row_id"]: row_continuity_summary(environment_row),
            resource_row["row_id"]: row_continuity_summary(resource_row),
        },
        "limit_rows_for_i9": {
            "n18_i7_row_02_h4_environment_boundary_pressure_limit": (
                "partial environment boundary-to-loop-feedback limit"
            ),
            "n18_i7_row_04_h4_resource_access_budget_limit": (
                "rejected resource stress budget-only limit"
            ),
            "n18_i7_row_05_h4_compound_environment_resource_limit": (
                "rejected compound environment/resource boundary"
            ),
        },
        "blocked_relabels": {
            "resource_access_is_semantic_goal_ownership": False,
            "resource_access_is_resource_as_self": False,
        },
    }


def make_checks(rows: list[dict[str, Any]], source_rows: list[dict[str, Any]], i6: dict[str, Any]) -> list[dict[str, Any]]:
    by_id = row_by_id(rows)
    checks = [
        {
            "check_id": "iteration6_h4_l4_anchor_ready",
            "detail": i6.get("iteration7_handoff", {}),
            "passed": i6.get("ready_for_iteration_7_environment_resource_stress")
            is True
            and i6.get("iteration7_handoff", {}).get("primary_horizon_anchor")
            == "h4",
        },
        {
            "check_id": "environment_resource_positive_rows_supported",
            "detail": {
                "environment": by_id[
                    "n18_i7_row_01_h4_environment_boundary_pressure_bounded"
                ]["row_decision"],
            ...
            == "supported"
            and by_id["n18_i7_row_03_h4_resource_access_perturbation_bounded"][
                "row_decision"
            ]
            == "supported",
        },
        {
            "check_id": "environment_resource_limits_fail_closed",
            "detail": {
                "compound": by_id[
                    "n18_i7_row_05_h4_compound_environment_resource_limit"
                ]["row_decision"],
                "environment_pressure": by_id[
                    "n18_i7_row_02_h4_environment_boundary_pressure_limit"
                ]["row_decision"],
                "resource_budget": by_id[
                    "n18_i7_row_04_h4_resource_access_budget_limit"
                ]["row_decision"],
            },
            "passed": by_id[
            ...
            == "partial"
            and by_id["n18_i7_row_04_h4_resource_access_budget_limit"][
                "row_decision"
            ]
            == "rejected"
            and by_id["n18_i7_row_05_h4_compound_environment_resource_limit"][
                "row_decision"
            ]
            == "rejected",
        },
        {
            "check_id": "resource_goal_and_self_relabels_fail_closed",
            "detail": {
                "goal_ownership": by_id[
                    "n18_i7_row_06_resource_goal_ownership_relabel_control"
                ]["row_decision"],
                "resource_as_self": by_id[
                    "n18_i7_row_07_resource_as_self_relabel_control"
                ]["row_decision"],
            },
            "passed": by_id["n18_i7_row_06_resource_goal_ownership_relabel_control"][
                "row_decision"
            ]
            == "rejected"
            and by_id[
        ...
        {
            "check_id": "boundary_to_loop_feedback_bottleneck_preserved_for_iteration8",
            "detail": {
                "axis": "loop_feedback",
    ...
    checks.extend(source_digest_checks(source_rows, i6))
    return checks
...
def write_report(payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        f"environment_boundary_pressure_supported = {str(payload['family_summary']['environment_boundary_pressure_supported']).lower()}",
        f"resource_access_perturbation_supported = {str(payload['family_summary']['resource_access_perturbation_supported']).lower()}",
        f"current_bottleneck_axis = {payload['iteration8_handoff']['current_bottleneck_axis']}",
        f"current_bottleneck_link = {payload['iteration8_handoff']['current_bottleneck_link']}",
...
def main() -> None:
    ...
    i6 = load_json(I6_ROUTE_MEMORY)
    source_rows = selected_source_rows(inventory)
    rows = [
        make_row(schema=schema, source_rows=source_rows, i6=i6, spec=spec)
        for spec in ROW_SPECS
    ]
    checks = make_checks(rows, source_rows, i6)
    ...
    payload = {
        ...
        "ap8_candidate_allowed": False,
        "artifact_id": "n18_environment_resource_stress_matrix",
        "checks": checks,
        ...
        "iteration": 7,
        "iteration8_handoff": iteration8_handoff(rows),
        ...
        "purpose": "environment/resource perturbation stress matrix",
        "ready_for_iteration_8_shared_medium_stress": not failed_checks,
        "row_count": len(rows),
        "rows": rows,
        "schema_version": "n18.environment_resource_stress_matrix.v1",
        "source_backed_horizon_envelope": horizon_envelope(),
        "source_inventory": {
        ...
        "source_predecessor": {
            "artifact_id": i6["artifact_id"],
            "output_digest": i6["output_digest"],
            "path": rel(I6_ROUTE_MEMORY),
            "sha256": sha256_file(I6_ROUTE_MEMORY),
        },
