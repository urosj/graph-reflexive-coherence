...
| [N27 configuration/substrate transfer](2026-06-N27-lgrc-configuration-substrate-transfer/README.md) | Iteration 2 passed: transfer schema and controls are frozen with CT0-CT6/N27-C0-N27-C6 ladders, N20 I5 normative contract consumption, source digest pins, transfer-core fields, row-local AP4/AP5 statuses, and fail-closed blockers. Positive transfer evidence is not yet opened; I3 active nulls are next. | README, hypotheses, implementation plan/checklist, I1 source inventory, and I2 schema/control freeze. |
