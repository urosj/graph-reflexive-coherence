...
| [N27 configuration/substrate transfer](2026-06-N27-lgrc-configuration-substrate-transfer/README.md) | Iteration 3 passed: all 22 frozen transfer controls instantiate as active nulls and fail closed, with zero failed-open rows. Positive transfer evidence remains closed; I4 minimal configuration transfer probe is next. | README, hypotheses, implementation plan/checklist, I1 source inventory, I2 schema/control freeze, and I3 active-null matrix. |
