...
| [N28 generative vs extractive persistence](2026-06-N28-lgrc-generative-vs-extractive-persistence/README.md) | Initialized final becoming-primitive evidence experiment for bounded artifact-level generative versus extractive persistence: focal basin stability plus neighborhood basin-forming capacity, extraction, flattening, merge/leakage, medium-debt, and claim-boundary controls. Positive N28 evidence is not yet opened. | README, hypotheses, implementation plan/checklist, and N27 handoff context. |
