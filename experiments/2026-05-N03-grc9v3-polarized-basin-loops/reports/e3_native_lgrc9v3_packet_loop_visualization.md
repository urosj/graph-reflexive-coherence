...
```bash
.venv/bin/python experiments/2026-05-N03-grc9v3-polarized-basin-loops/scripts/visualize_e3_native_lgrc9v3_packet_loop.py
```

Generated artifacts:

- `reports/e3_native_lgrc9v3_packet_loop_visualization.svg`
- `outputs/e3_native_lgrc9v3_packet_loop_visualization.json`

The SVG visualizes the native clockwise and counter-clockwise E3 routes, the first three completed cycles for each direction, and the claim boundary. It is regenerated from native LGRC9V3 E3 positive runs, not from the old D2.3 prototype runner.
