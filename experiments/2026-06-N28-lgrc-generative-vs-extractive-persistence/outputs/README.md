...
- `n28_source_inventory_and_contract_admission.json` - Iteration 1 source
  inventory and contract admission. Consumes N20 generative/extractive
  contracts and N27 precursor context without opening positive N28 evidence.
- `n28_generative_extractive_schema_and_controls.json` - Iteration 2 schema
  and control freeze. Defines the three-axis classifier, GE/N28-C ladders,
  source digest pins, core digest policy, controls, replay rules, and claim
  boundary without opening positive evidence.
