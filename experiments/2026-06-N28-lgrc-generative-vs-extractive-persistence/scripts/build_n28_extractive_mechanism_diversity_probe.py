#!/usr/bin/env python3
"""Build N28 Iteration 4-C2 source-current extractive mechanism-diversity probe."""
...
OUTPUT = EXPERIMENT / "outputs" / "n28_extractive_mechanism_diversity_probe.json"
REPORT = EXPERIMENT / "reports" / "n28_extractive_mechanism_diversity_probe.md"
ARTIFACT_DIR = EXPERIMENT / "outputs" / "n28_extractive_mechanism_diversity_probe_artifacts"
SCRIPT_RELATIVE_PATH = (
    "experiments/2026-06-N28-lgrc-generative-vs-extractive-persistence/scripts/"
    "build_n28_extractive_mechanism_diversity_probe.py"
)
...
def build_traces(i3: dict[str, Any]) -> dict[str, Any]:
    ...
    threshold_policy = {
        "policy_id": "n28_i4c2_extractive_mechanism_diversity_policy_v1",
    ...
    runtime_trace = {
        "run_artifact_id": "n28_i4c2_extractive_mechanism_diversity_runtime_trace",
        "runtime_config_id": "n28_i4c2_merge_leakage_flattening_fixture_v1",
        ...
        "focal_basin_id": "n28_i4c2_focal_basin_zeta",
        "neighbor_scope_id": "n28_i4c2_neighbor_capacity_shell_zeta",
        "mechanism_class": "merge_leakage_dominant_boundary_flattening",
        "mechanism_distinction_from_i4b": "I4-B uses a gamma local shell drain; I4-C2 is dominated by merge/leakage and boundary flattening.",
        "mechanism_distinction_from_i4c": "I4-C uses a delta cross-shell directional drain; I4-C2 tests boundary-flattening extractive loss.",
        "cross_shell_directional_drain_used": False,
        "steps": [
            {
                "step": 0,
                ...
                "neighbor_distinguishability": 0.721,
                "neighbor_support_floor": 0.742,
                "neighbor_boundary_integrity": 0.716,
                "environment_basin_forming_capacity": 0.687,
                "focal_extraction_cost": 0.017,
                "extractive_flattening_score": 0.018,
                "merge_leakage_score": 0.017,
                "boundary_flattening_band_width": 0.041,
            },
            {
                "step": 1,
                "focal_support_min": 0.868,
                "focal_coherence_min": 0.875,
                "focal_stability_score": 0.871,
                "neighbor_distinguishability": 0.646,
                "neighbor_support_floor": 0.687,
                "neighbor_boundary_integrity": 0.612,
                "environment_basin_forming_capacity": 0.622,
                "focal_extraction_cost": 0.038,
                "extractive_flattening_score": 0.048,
                "merge_leakage_score": 0.043,
                "boundary_flattening_band_width": 0.096,
            },
        ],
    }
    ...
    focal_trace = {
        "trace_id": "n28_i4c2_focal_basin_stability_trace",
        "focal_basin_id": runtime_trace["focal_basin_id"],
    ...
    neighbor_trace = {
        "trace_id": "n28_i4c2_neighbor_capacity_trace",
        "neighbor_scope_id": runtime_trace["neighbor_scope_id"],
    ...
    extraction_trace = {
        "trace_id": "n28_i4c2_extraction_leakage_trace",
    ...
    capacity_attribution_trace = {
        "trace_id": "n28_i4c2_capacity_attribution_trace",
        ...
        "cross_shell_directional_drain_used": False,
        "attribution_result": "source_current_neighbor_capacity_degradation_by_merge_leakage_boundary_flattening",
    }
    classification_trace = {
        "trace_id": "n28_i4c2_extractive_mechanism_diversity_classification_trace",
        ...
        "classification_reason": (
            "stable focal basin + degraded neighborhood capacity + merge/leakage-dominant boundary flattening mechanism"
        ),
...
def build_output() -> dict[str, Any]:
    ...
    row = {
        ...
        "row_decision_scope": "provisional_GE3_extractive_mechanism_diversity_measured_contrast_pending_replay_controls_and_neutral_contrasts",
        "ge_ladder_rung": "GE3",
        ...
        "shared_regime_policy_status_scope": (
            "generative_primary_i4a_i4a2_plus_primary_strengthening_and_mechanism_diverse_extractive_contrasts_pending_neutral_contrasts"
        ),
        "policy_divergence_record": {
            "policy_id": traces["threshold_policy"]["policy_id"],
            "divergence_status": "same_policy_family_preserved_for_extractive_mechanism_diversity_contrast_pending_neutral_contrast_rows",
            "affected_regimes": ["competitive", "neutral"],
        ...
        "artifact_role_alias_map": {
            ...
            "classification_trace": [
                ...
                "policy_divergence_record",
                "extractive_strengthening_margin_comparison",
                "extractive_mechanism_diversity_record",
            ],
        ...
        "extractive_mechanism_diversity_record": {
            "mechanism_diversity_role": "true_alternative_extractive_mechanism",
            "mechanism_class": traces["runtime_trace"]["mechanism_class"],
            "i4b_mechanism_class": "gamma_local_shell_drain",
            "i4c_mechanism_class": "delta_cross_shell_directional_drain",
            ...
            "mechanism_evidence_fields": [
                ...
                "capacity_attribution_trace.merge_leakage_dominant",
                "capacity_attribution_trace.boundary_flattening_dominant",
                "source_current_runtime_trace.step.boundary_flattening_band_width",
            ],
        },
        "medium_debt_record": {
            "medium_debt_fields": [
        ...
        "row_local_controls_scope": "extractive_strengthening_GE3_applicable_controls",
        ...
        "ap4_condition_reason": "I4-C2 extractive mechanism-diversity fixture does not make route-conditioned selection claim; AP4/N14 NAT4 gap remains inherited context.",
        "ap5_dependency_status": "not_applicable",
        "ap5_condition_reason": "I4-C2 extractive mechanism-diversity fixture does not use proxy/target formation as positive evidence; AP5/N15 NAT4 gap remains unresolved.",
        "claim_ceiling": "provisional_GE3_extractive_mechanism_diversity_measured_contrast_pending_replay_controls_neutral_contrasts_and_stress",
    ...
    row["extractive_contrast_record"] = {
        ...
        "primary_extractive_source_consumed_for_margin_comparison_only": i4b[
            "output_digest"
        ],
    ...
    row["extractive_strengthening_margin_comparison"] = extractive_margin_comparison(
        row, i4b["candidate_rows"][0]
    )
    ...
    checks = [
        ...
        },
        {
            ...
            and row["row_local_controls_scope"] == "extractive_strengthening_GE3_applicable_controls"
            and row["full_controls_pending_for_ge4_plus"] is True,
        },
        {
            "check_id": "shared_policy_status_bounded_to_extractive_mechanism_diversity",
            "passed": row["shared_regime_policy_status"] == "partially_supported"
            and row["shared_regime_policy_status_scope"]
            == "generative_primary_i4a_i4a2_plus_primary_strengthening_and_mechanism_diverse_extractive_contrasts_pending_neutral_contrasts",
        },
        {
            "check_id": "extractive_mechanism_diversity_not_margin_optimization_only",
            "passed": row["extractive_mechanism_diversity_record"]["different_from_i4b"]
            is True
            and row["extractive_mechanism_diversity_record"]["different_from_i4c"]
            is True
            and row["extractive_mechanism_diversity_record"][
                "not_margin_optimization_only"
            ]
            is True
            and row["extractive_mechanism_diversity_record"]["merge_leakage_dominant"]
            is True
            and row["extractive_mechanism_diversity_record"][
                "boundary_flattening_dominant"
            ]
            is True
            and row["extractive_mechanism_diversity_record"][
                "cross_shell_directional_drain_used"
            ]
            is False,
        },
        {
    ...
    output = {
        "artifact_id": "n28_extractive_mechanism_diversity_probe",
        ...
        "extractive_contrast_promoted_to_generative": False,
        "i4c2_mechanism_diversity_supported": True,
...
def write_report(output: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        f"- Mechanism diversity supported: `{str(output['i4c2_mechanism_diversity_supported']).lower()}`",
        f"- Ready for I4-D: `{str(output['ready_for_iteration_4d_primary_competitive_neutral_contrast']).lower()}`",
        "",
        "I4-C2 adds source-current extractive mechanism-diversity evidence. It "
        "does not try to be a stronger-margin copy of I4-B or I4-C. Instead, "
        "it preserves focal viability while neighboring capacity degrades under "
        "a merge/leakage-dominant boundary-flattening mechanism. The row is "
        "extractive contrast evidence, not generative evidence.",
        "",
        "## Candidate Metrics",
        "",
        "```text",
        ...
        "## Interpretation",
        "",
        "Geometrically, I4-C2 repeats the extractive predicate through a "
        "different mechanism class. The focal zeta basin remains above support, "
        "coherence, and stability floors, but the neighboring shell loses "
        "distinguishability, support, boundary integrity, and basin-forming "
        "capacity as boundary flattening and merge/leakage rise above the "
        "generative ceilings.",
        "",
        "This differs from both earlier extractive rows. I4-B used a gamma "
        "local shell drain. I4-C used a delta cross-shell directional drain. "
        "I4-C2 uses zeta boundary flattening where merge/leakage dominates. "
        "The result strengthens the extractive side by mechanism diversity, "
        "not by optimizing the same trace for larger margins.",
        "",
        "Compactly: I4-C2 shows focal persistence with neighbor capacity loss "
        "through merge/leakage and boundary flattening, while keeping the same "
        "frozen classifier and claim boundary.",
        "",
        "I4-C2 consumes I4-B and I4-C only as context for mechanism comparison. "
        "It does not import either row as evidence, replace them, widen "
        "thresholds, or promote extractive behavior to generative support. "
        "Replay/control validation remains pending for GE4+.",
        "",
        ...
        f"strengthens_extractives_by_mechanism_diversity = {str(row['extractive_contrast_record']['strengthens_extractives_by_mechanism_diversity']).lower()}",
        ...
        "",
        "```text",
        f"mechanism_class = {row['extractive_mechanism_diversity_record']['mechanism_class']}",
        f"different_from_i4b = {str(row['extractive_mechanism_diversity_record']['different_from_i4b']).lower()}",
        f"different_from_i4c = {str(row['extractive_mechanism_diversity_record']['different_from_i4c']).lower()}",
        f"not_margin_optimization_only = {str(row['extractive_mechanism_diversity_record']['not_margin_optimization_only']).lower()}",
        f"merge_leakage_dominant = {str(row['extractive_mechanism_diversity_record']['merge_leakage_dominant']).lower()}",
        f"boundary_flattening_dominant = {str(row['extractive_mechanism_diversity_record']['boundary_flattening_dominant']).lower()}",
        "```",
        "",
        "## Checks",
        "",
    ...
    lines.extend(
        [
            ...
            "## Claim Boundary",
            "",
            "I4-C2 does not support GE4+, GE5+, GE6, final N28, semantic cooperation, "
