#!/usr/bin/env python3
"""Build N28 Iteration 4-A source-current generative strengthening probe."""
...
OUTPUT = EXPERIMENT / "outputs" / "n28_generative_strengthening_candidate_probe.json"
REPORT = EXPERIMENT / "reports" / "n28_generative_strengthening_candidate_probe.md"
ARTIFACT_DIR = EXPERIMENT / "outputs" / "n28_generative_strengthening_candidate_probe_artifacts"
SCRIPT_RELATIVE_PATH = (
    "experiments/2026-06-N28-lgrc-generative-vs-extractive-persistence/scripts/"
    "build_n28_generative_strengthening_candidate_probe.py"
)
...
def build_traces(i3: dict[str, Any]) -> dict[str, Any]:
    ...
    threshold_policy = {
        "policy_id": "n28_i4a_generative_strengthening_policy_v1",
    ...
    runtime_trace = {
        "run_artifact_id": "n28_i4a_generative_strengthening_runtime_trace",
        "runtime_config_id": "n28_i4a_strengthening_fixture_v1",
        ...
        "focal_basin_id": "n28_i4a_focal_basin_beta",
        "neighbor_scope_id": "n28_i4a_neighbor_capacity_shell_beta",
        "steps": [
            {
                "step": 0,
                "focal_support_min": 0.881,
                "focal_coherence_min": 0.889,
                "focal_stability_score": 0.887,
                "neighbor_distinguishability": 0.604,
                "neighbor_support_floor": 0.664,
                "neighbor_boundary_integrity": 0.579,
                "environment_basin_forming_capacity": 0.572,
                "focal_extraction_cost": 0.014,
                "extractive_flattening_score": 0.011,
                "merge_leakage_score": 0.01,
            },
            {
                "step": 1,
                "focal_support_min": 0.879,
                "focal_coherence_min": 0.887,
                "focal_stability_score": 0.889,
                "neighbor_distinguishability": 0.758,
                "neighbor_support_floor": 0.751,
                "neighbor_boundary_integrity": 0.724,
                "environment_basin_forming_capacity": 0.706,
                "focal_extraction_cost": 0.016,
    ...
    focal_trace = {
        "trace_id": "n28_i4a_focal_basin_stability_trace",
        "focal_basin_id": runtime_trace["focal_basin_id"],
    ...
    neighbor_trace = {
        "trace_id": "n28_i4a_neighbor_capacity_trace",
        "neighbor_scope_id": runtime_trace["neighbor_scope_id"],
    ...
    extraction_trace = {
        "trace_id": "n28_i4a_extraction_leakage_trace",
    ...
    capacity_attribution_trace = {
        "trace_id": "n28_i4a_capacity_attribution_trace",
    ...
    classification_trace = {
        "trace_id": "n28_i4a_generative_strengthening_classification_trace",
...
def build_output() -> dict[str, Any]:
    ...
    row = {
        "row_id": "n28_i4a_row_generative_strengthening_candidate",
        "iteration": "4-A",
        "row_decision": "supported",
        "row_decision_scope": "provisional_GE3_generative_strengthening_candidate_pending_replay_controls_and_contrasts",
        "ge_ladder_rung": "GE3",
        ...
        "shared_regime_policy_status_scope": (
            "strengthened_by_primary_and_i4a_pending_extractives_and_neutral_contrasts"
        ),
        "policy_divergence_record": {
            "policy_id": traces["threshold_policy"]["policy_id"],
            "divergence_status": "same_policy_family_preserved_for_strengthening_row_pending_contrast_rows",
            ...
            "claim_effect": "GE3_strengthening_candidate_no_shared_policy_closeout",
        },
        ...
        "row_local_controls_scope": "strengthening_GE3_applicable_controls",
        ...
        "ap4_condition_reason": "I4-A generative strengthening fixture does not make route-conditioned selection claim; AP4/N14 NAT4 gap remains inherited context.",
        "ap5_dependency_status": "not_applicable",
        "ap5_condition_reason": "I4-A generative strengthening fixture does not use proxy/target formation as positive evidence; AP5/N15 NAT4 gap remains unresolved.",
        "claim_ceiling": "provisional_GE3_generative_strengthening_candidate_pending_replay_controls_contrasts_and_stress",
    ...
    checks = [
        ...
        },
        {
            ...
            and row["row_local_controls_scope"] == "strengthening_GE3_applicable_controls"
            and row["full_controls_pending_for_ge4_plus"] is True,
        },
        {
            "check_id": "shared_policy_status_bounded_to_strengthening_evidence",
    ...
    output = {
        "artifact_id": "n28_generative_strengthening_candidate_probe",
        ...
        "generative_strengthening_candidate_supported": True,
...
def write_report(output: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "",
        "I4-A strengthens the I4 generative evidence by producing a distinct "
        "source-current GE3 generative row under the same frozen policy family. "
        "It does not replace I4 and does not retune thresholds.",
        "",
        "## Candidate Metrics",
        "",
        "```text",
        ...
        "## Interpretation",
        "",
        "The row passes the three-axis I2 classifier locally and compares against "
        "I4 on every load-bearing margin. Focal stability, neighbor "
        "distinguishability, neighbor support, neighbor boundary integrity, and "
        "environment capacity are comparable or stronger than I4, while "
        "extraction, flattening, and merge/leakage are lower or equal. This "
        "corroborates I4 as a generative pattern, but still does not support "
        "final generative persistence or shared-policy closeout.",
        "",
        "In geometric dynamics terms, I4-A shows the same kind of persistence "
        "with neighboring capacity increase in a distinct local setup. The "
        "focal basin remains viable while the adjacent shell gains separation, "
        "support, boundary integrity, and basin-forming capacity without being "
        "drained, flattened, or merged into the focal basin.",
        "",
        "Topology-wise, I4 is the primary alpha case: focal basin alpha remains "
        "stable while neighbor capacity shell alpha becomes more basin-capable "
        "and extraction/flattening/merge-leakage stay low. I4-A repeats the "
        "same kind of event in a distinct beta setup: focal basin beta remains "
        "stable while neighbor capacity shell beta becomes more basin-capable, "
        "again without absorption, drainage, or merge/leakage masquerading as "
        "support.",
        "",
        "The topology difference is not new basin birth and not a replay-backed "
        "topology transition. It is a different local basin/shell configuration: "
        "different focal basin id, different neighbor shell id, different "
        "runtime fixture digest, and a stronger capacity margin profile.",
        "",
        "The `shared_regime_policy_status = partially_supported` field is scoped "
        "to the primary I4 row plus this I4-A strengthening row. It does not "
        "settle the shared policy family until extractive contrasts and "
        "competitive/neutral contrasts exist.",
        "",
        "I4-A inherits the I3 active-null matrix as a fail-closed false-positive "
        "boundary and consumes I4 only as the comparison target. Its row-local "
        "controls are only the strengthening GE3-applicable controls; the full "
        "replay/control matrix remains pending for GE4+.",
        "",
        "## I4 Comparison",
        "",
    ...
    lines.extend(
        [
            ...
            "## Claim Boundary",
            "",
            "I4-A does not support GE4+, GE5+, GE6, final N28, semantic cooperation, "
