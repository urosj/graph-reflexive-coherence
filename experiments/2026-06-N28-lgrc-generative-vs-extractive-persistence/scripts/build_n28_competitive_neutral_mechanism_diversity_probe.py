#!/usr/bin/env python3
"""Build N28 Iteration 4-E competitive/neutral mechanism-diversity probe."""
...
OUTPUT = EXPERIMENT / "outputs" / "n28_competitive_neutral_mechanism_diversity_probe.json"
REPORT = EXPERIMENT / "reports" / "n28_competitive_neutral_mechanism_diversity_probe.md"
ARTIFACT_DIR = EXPERIMENT / "outputs" / "n28_competitive_neutral_mechanism_diversity_probe_artifacts"
SCRIPT_RELATIVE_PATH = (
    "experiments/2026-06-N28-lgrc-generative-vs-extractive-persistence/scripts/"
    "build_n28_competitive_neutral_mechanism_diversity_probe.py"
)
...
def build_traces(i3: dict[str, Any]) -> dict[str, Any]:
    ...
    threshold_policy = {
        "policy_id": "n28_i4e_competitive_neutral_mechanism_diversity_policy_v1",
    ...
    runtime_trace = {
        "run_artifact_id": "n28_i4e_competitive_neutral_mechanism_diversity_runtime_trace",
        "runtime_config_id": "n28_i4e_three_lobe_circulatory_exchange_fixture_v1",
        ...
        "focal_basin_id": "n28_i4e_focal_basin_theta",
        "neighbor_scope_id": "n28_i4e_circulatory_neighbor_field_theta",
        "mechanism_class": "three_lobe_circulatory_capacity_exchange",
        "mechanism_distinction_from_i4d": "I4-D uses a direct two-lobe competitive gain/loss pair; I4-E uses a three-lobe circulation where capacity is routed through gain, loss, and buffer lobes with near-neutral aggregate change.",
        ...
        "steps": [
            {
                ...
                "neighbor_distinguishability": 0.693,
                "neighbor_support_floor": 0.719,
                "neighbor_boundary_integrity": 0.671,
                "environment_basin_forming_capacity": 0.651,
                "focal_extraction_cost": 0.021,
                "extractive_flattening_score": 0.018,
                "merge_leakage_score": 0.017,
                "neighbor_lobes": {
                    "inflow_lobe_capacity": 0.613,
                    "outflow_lobe_capacity": 0.617,
                    "buffer_lobe_capacity": 0.611
                },
            },
            {
                "step": 1,
                ...
                "neighbor_distinguishability": 0.701,
                "neighbor_support_floor": 0.713,
                "neighbor_boundary_integrity": 0.678,
                "environment_basin_forming_capacity": 0.649,
                "focal_extraction_cost": 0.027,
                "extractive_flattening_score": 0.023,
                "merge_leakage_score": 0.020,
                "neighbor_lobes": {
                    "inflow_lobe_capacity": 0.660,
                    "outflow_lobe_capacity": 0.572,
                    "buffer_lobe_capacity": 0.613
                },
            },
        ],
    }
    ...
    neighbor_trace = {
        "trace_id": "n28_i4e_neighbor_capacity_trace",
        "neighbor_scope_id": runtime_trace["neighbor_scope_id"],
    ...
    extraction_trace = {
        "trace_id": "n28_i4e_extraction_leakage_trace",
    ...
    capacity_attribution_trace = {
        "trace_id": "n28_i4e_capacity_attribution_trace",
        ...
        "attribution_result": "source_current_neutral_circulatory_neighbor_capacity_exchange",
    }
    classification_trace = {
        "trace_id": "n28_i4e_competitive_neutral_mechanism_diversity_classification_trace",
        ...
        "neighborhood_capacity_axis": "near_neutral_circulatory_exchange",
        ...
        "classification_reason": (
            "stable focal basin + near-neutral three-lobe capacity circulation + bounded extraction/leakage below extractive ceiling"
        ),
...
def build_output() -> dict[str, Any]:
    ...
    row = {
        "row_id": "n28_i4e_row_competitive_neutral_mechanism_diversity_contrast",
        "iteration": "4-E",
        "row_decision": "supported",
        "row_decision_scope": "provisional_GE3_competitive_neutral_mechanism_diversity_measured_contrast_pending_replay_controls",
        "ge_ladder_rung": "GE3",
        ...
        "shared_regime_policy_status_scope": (
            "generative_primary_i4a_i4a2_plus_extractives_i4b_i4c_i4c2_plus_competitive_i4d_and_neutral_i4e_pending_replay_controls"
        ),
        "policy_divergence_record": {
            "policy_id": traces["threshold_policy"]["policy_id"],
            "divergence_status": "same_policy_family_preserved_for_competitive_neutral_mechanism_diversity_contrast_pending_replay_controls",
            "affected_regimes": ["neutral_mechanism_diversity"],
            "same_policy_failed_reason": "not_failed",
            "split_policy_allowed": "only_if_later_rows_record_blocker",
            "post_hoc_retuning_used": False,
            "claim_effect": "GE3_measured_neutral_mechanism_diversity_contrast_no_shared_policy_closeout",
        },
        ...
        "source_i4d_primary_competitive_neutral_output_digest": i4d["output_digest"],
        "source_i4d_primary_competitive_neutral_row_digest": i4d["candidate_rows"][0]["row_digest"],
        ...
        "artifact_role_alias_map": {
            ...
            "classification_trace": [
                ...
                "competitive_neutral_mechanism_diversity_record",
            ],
        ...
        "competitive_neutral_boundary_record": {
            "boundary_role": "alternative_competitive_neutral_mechanism_diversity_contrast",
        ...
        "competitive_neutral_mechanism_diversity_record": {
            "mechanism_diversity_role": "true_alternative_competitive_neutral_mechanism",
            "mechanism_class": traces["runtime_trace"]["mechanism_class"],
            "different_from_i4d": True,
            "i4d_mechanism_class": i4d["candidate_rows"][0]["competitive_neutral_boundary_record"][
                "mechanism_class"
            ],
            "not_margin_optimization_only": True,
            "not_threshold_retuning": True,
            "not_relabeled_i4d_copy": True,
            "source_current_mechanism_fields": [
                "runtime_trace.neutral_circulation_used",
                "runtime_trace.direct_two_lobe_pair_used",
                "capacity_attribution_trace.inflow_lobe_capacity_delta",
                "capacity_attribution_trace.outflow_lobe_capacity_delta",
                "capacity_attribution_trace.buffer_lobe_capacity_delta",
            ],
            "mechanism_interpretation": (
                "I4-D is a direct two-lobe competitive redistribution; I4-E is "
                "a three-lobe neutral circulation where capacity is routed through "
                "gain, loss, and buffer lobes while aggregate neighbor capacity stays near neutral."
            ),
        },
        "medium_debt_record": {
            "medium_debt_fields": [
        ...
        "row_local_controls_scope": "competitive_neutral_mechanism_diversity_GE3_applicable_controls",
        ...
        "control_results": [
            {
                ...
                "actual_result": "neighborhood_capacity_is_neutral_circulatory_not_materially_generative",
            ...
            },
            {
                ...
                "control_status": "passed",
                "actual_result": "three_lobe_circulation_capacity_traces_present_not_label_only",
                "claim_allowed_when_control_triggers": False,
                "rung_effect": "GE3_measured_contrast_preserved",
            },
            {
            ...
            {
                "control_id": "neutral_promoted_to_generative_control",
                "control_status": "passed",
                "actual_result": "row_classified_neutral_and_not_promoted_to_generative",
                "claim_allowed_when_control_triggers": False,
                "rung_effect": "GE3_measured_contrast_preserved",
            },
            {
                "control_id": "i4d_relabel_as_i4e_control",
                "control_status": "passed",
                "actual_result": "I4E_uses_three_lobe_circulation_not_I4D_two_lobe_pair",
                "claim_allowed_when_control_triggers": False,
                "rung_effect": "GE3_measured_contrast_preserved",
            },
        ],
        "ap4_dependency_status": "not_applicable",
        "ap4_condition_reason": "I4-E competitive/neutral mechanism-diversity fixture does not make route-conditioned selection claim; AP4/N14 NAT4 gap remains inherited context.",
        "ap5_dependency_status": "not_applicable",
        "ap5_condition_reason": "I4-E competitive/neutral mechanism-diversity fixture does not use proxy/target formation as positive evidence; AP5/N15 NAT4 gap remains unresolved.",
        "claim_ceiling": "provisional_GE3_competitive_neutral_mechanism_diversity_measured_contrast_pending_replay_controls_and_stress",
    ...
    row["same_frozen_policy_family_as_i4d"] = (
        row["shared_regime_policy_id"]
        == i4d["candidate_rows"][0]["shared_regime_policy_id"]
    )
    row["competitive_neutral_contrast_record"] = {
        ...
        "competitive_neutral_sources_consumed_as_context_only": [
            i4d["output_digest"],
        ],
        ...
        "neighborhood_capacity_circulatory_or_neutral": True,
        ...
        "classified_as_competitive": False,
        "classified_as_neutral": True,
        "valid_measured_contrast": True,
        "sharpens_regime_boundary": True,
        "strengthens_competitive_neutral_side_by_mechanism_diversity": True,
    }
    ...
    checks = [
        ...
        {
            "check_id": "i4d_primary_competitive_contrast_consumed_for_comparison",
            "passed": i4d.get("status") == "passed"
            and i4d.get("failed_checks") == []
            and i4d.get("output_digest") == EXPECTED_I4D_DIGEST
            and i4d.get("primary_competitive_neutral_contrast_supported") is True,
        },
        {
        ...
        {
            "check_id": "neutral_circulatory_exchange_present",
            "passed": row["competitive_neutral_boundary_record"][
                "neutral_circulation_detected"
            ]
            is True
            and row["competitive_neutral_boundary_record"]["inflow_lobe_capacity_delta"]
            >= traces["threshold_policy"]["mixed_lobe_delta_min"]
            and row["competitive_neutral_boundary_record"]["outflow_lobe_capacity_delta"]
            <= -traces["threshold_policy"]["mixed_lobe_delta_min"]
            and abs(row["competitive_neutral_boundary_record"]["buffer_lobe_capacity_delta"])
            <= traces["threshold_policy"]["competitive_neutral_abs_delta_max"],
        },
        {
        ...
        },
        {
            ...
            == "competitive_neutral_mechanism_diversity_GE3_applicable_controls"
            and row["full_controls_pending_for_ge4_plus"] is True,
        },
        {
            "check_id": "shared_policy_status_bounded_to_competitive_neutral_mechanism_diversity",
        ...
        },
        {
            ...
            is True
            and row["competitive_neutral_boundary_record"]["neutral_circulation_detected"]
            is True
            and row["competitive_neutral_boundary_record"][
                "direct_two_lobe_competitive_pair_used"
            ]
            is False
            and row["competitive_neutral_boundary_record"][
        ...
        {
            "check_id": "competitive_neutral_mechanism_diversity_not_i4d_relabel",
            "passed": row["competitive_neutral_mechanism_diversity_record"][
                "different_from_i4d"
            ]
            is True
            and row["competitive_neutral_mechanism_diversity_record"][
                "not_margin_optimization_only"
            ]
            is True
            and row["competitive_neutral_mechanism_diversity_record"][
                "not_relabeled_i4d_copy"
            ]
            is True
            and row["competitive_neutral_mechanism_diversity_record"][
                "not_threshold_retuning"
            ]
            is True,
        },
        {
            "check_id": "neutral_contrast_not_promoted_to_generative_or_extractive",
            "passed": row["regime_label"] == "neutral"
            and row["regime_evidence_role"] == "measured_contrast_alternative"
            ...
            and row["same_frozen_policy_family_as_i4d"] is True,
        },
        {
    ...
    output = {
        "artifact_id": "n28_competitive_neutral_mechanism_diversity_probe",
        ...
        "source_i4d_primary_competitive_neutral": {
            "path": I4D_OUTPUT_PATH,
            "output_digest": i4d["output_digest"],
            "artifact_sha256": sha256_file(I4D_OUTPUT_PATH),
            "status": i4d["status"],
            "acceptance_state": i4d["acceptance_state"],
            "row_digest": i4d["candidate_rows"][0]["row_digest"],
        },
        ...
        "primary_competitive_neutral_contrast_consumed": True,
...
def write_report(output: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        f"- Ready for I5: `{str(output['ready_for_iteration_5_replay_and_capacity_attribution_matrix']).lower()}`",
        "",
        "I4-E adds a source-current competitive/neutral mechanism-diversity "
        "contrast. The focal basin remains viable while neighboring capacity "
        "circulates through three shell lobes rather than the direct two-lobe "
        "competitive pair used by I4-D. The row strengthens the middle regime "
        "boundary without promoting the neutral result to generative or "
        "extractive support.",
        "",
        "## Candidate Metrics",
        "",
        ...
        f"inflow_lobe_capacity_delta = {boundary['inflow_lobe_capacity_delta']}",
        f"outflow_lobe_capacity_delta = {boundary['outflow_lobe_capacity_delta']}",
        f"buffer_lobe_capacity_delta = {boundary['buffer_lobe_capacity_delta']}",
        "```",
        "",
        "## Interpretation",
        "",
        "Geometrically, I4-E sits in the same middle regime as I4-D but uses a "
        "different mechanism. The focal theta basin remains above support, "
        "coherence, and stability floors. The surrounding theta neighbor field "
        "does not become broadly more basin-capable, and it also does not "
        "collapse into the extractive loss pattern. Instead, capacity "
        "circulates through three shell lobes: an inflow lobe gains, an "
        "outflow lobe loses, and a buffer lobe remains near stable.",
        "",
        "This is not failed generativity and not weak extraction. It is a "
        "separate neutral processing regime: focal persistence with balanced "
        "environmental circulation. One part of the environment becomes more "
        "capable, another loses capacity, and a third carries the buffer, while "
        "aggregate neighbor capacity stays below material generative and "
        "extractive thresholds.",
        "",
        "In that sense I4-E can be read as a bounded processing or changing "
        ...
        "region is strengthened, one is reduced, and one buffers the exchange. "
        "The result is environmental circulation around a persisting basin, "
        "not net basin-forming enrichment and not broad extractive collapse.",
        "",
        ...
        "capacity loss; I4-D shows focal persistence with direct competitive "
        "redistribution; I4-E shows focal persistence with neutral three-lobe "
        "capacity circulation.",
        "",
        "I4-E consumes earlier generative, extractive, and I4-D competitive "
        "rows only as context for boundary separation. It does not import "
        "those outcomes as evidence, replace them, widen thresholds, or promote "
        "neutral circulation to generative support. Replay/control validation "
        "remains pending for GE4+.",
        "",
        ...
        "because this row is a neutral measured contrast, not a generative "
        "candidate.",
        "",
        "## Contrast Record",
        "",
        ...
        f"thresholds_retuned_to_force_neutral = {str(row['competitive_neutral_contrast_record']['thresholds_retuned_to_force_neutral']).lower()}",
        ...
        f"classified_as_neutral = {str(row['competitive_neutral_contrast_record']['classified_as_neutral']).lower()}",
        "```",
        "",
        ...
        f"different_from_i4d_competitive_case = {str(boundary['different_from_i4d_competitive_case']).lower()}",
        f"neutral_circulation_detected = {str(boundary['neutral_circulation_detected']).lower()}",
        f"direct_two_lobe_competitive_pair_used = {str(boundary['direct_two_lobe_competitive_pair_used']).lower()}",
    ...
    lines.extend(
        [
            ...
            "## Claim Boundary",
            "",
            "I4-E does not support GE4+, GE5+, GE6, final N28, semantic cooperation, "
