...
- `n31_semantic_representation_control_schema_i2.md` explains the independent
  classification axes, normalized evidence contracts, temporal/geometric
  mediation boundary, producer ownership, restoration scope, and fail-closed
  control policy.

## Iteration 3

- `n31_active_nulls_and_failure_baselines_i3.md` explains the 70-row control
