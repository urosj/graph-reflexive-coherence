...
def contradiction_entries() -> list[dict[str, Any]]:
    entries = [
        ...
        {
            "contradiction_id": "CR-GRV8-005A",
            "subject": "stationary_cycle_space_current",
            "claim_ids": ["T-A05"],
            "observed_result": "certified_cycle_current_seeds_are_overwritten_by_native_potential_flow_reconstruction",
            "route": "substrate_nonrealization",
            "theory_contradicted": False,
            "scope_limit": "tested_closed_positive_mobility_F3_potential_flow_envelope_only",
            "evidence_refs": ["outputs/return_orbit_registry.json"],
        },
        {
            "contradiction_id": "CR-GRV8-005B",
            "subject": "primitive_period_2_to_8_return_orbit_constructibility",
            "claim_ids": ["T-A03", "T-A04"],
            "observed_result": "no_primitive_return_orbit_was_found_among_resolved_candidates_while_ill_conditioned_and_relative_orbit_search_space_remains_open",
            "route": "construct_not_identifiable_with_available_interventions",
            "theory_contradicted": False,
            "scope_limit": "resolved_period_2_to_8_candidates_only_not_global_richer_fixture_or_relative_orbit_nonexistence",
            "evidence_refs": ["outputs/return_orbit_registry.json"],
        },
        {
    ...
    hardening = {
        ...
        "CR-GRV8-005A": {
            "assumption_statuses": {"A-CLOSED": "satisfied", "A-MOBILITY": "satisfied", "A-CONSERVE": "satisfied"},
            "secondary_alternatives": ["boundary_drive_or_null_sector_outside_tested_envelope"],
            "rejected_routes": ["global_substrate_nonrealization", "theory_contradiction"],
            "required_next_action": "retain_bounded_stationary_cycle_nonrealization_without_generalizing_beyond_tested_closed_F3_branches",
        },
        "CR-GRV8-005B": {
            "assumption_statuses": {"A-UNIQUENESS": "satisfied", "A-CLOCK": "satisfied", "A-STATE-CLOSURE": "satisfied_within_resolved_search_rows"},
            "secondary_alternatives": ["richer_fixture_or_relative_orbit", "ill_conditioned_return_map_sector"],
            "rejected_routes": ["substrate_nonrealization", "theory_contradiction"],
            "required_next_action": "preserve_bounded_negative_search_evidence_and_leave_unresolved_or_unsearched_orbit_families_open",
        },
        "CR-GRV8-006": {
