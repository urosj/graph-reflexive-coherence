...
def write_report(payload: dict[str, Any]) -> Path:
    ...
    lines = [
        ...
        f"phase_operator_pass_matrices = {summary['phase_operator_pass_matrix_count']}",
        f"basis_covariance_pass_matrices = {summary['basis_covariance_pass_matrix_count']}",
        f"symmetry_covariance_pass_pairs = {summary['symmetry_covariance_passed_pair_count']}",
        f"symmetry_covariance_failed_or_blocked_pairs = {summary['symmetry_covariance_failed_or_blocked_pair_count']}",
        f"omitted_state_decomposition_pass_branches = {summary['omitted_state_decomposition_pass_branch_count']}",
