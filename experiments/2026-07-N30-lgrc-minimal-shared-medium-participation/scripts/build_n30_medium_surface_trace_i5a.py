#!/usr/bin/env python3
"""Build N30 Iteration 5-A medium surface perturbation / trace probe."""
...
OUTPUT = EXPERIMENT / "outputs" / "n30_medium_surface_trace_i5a.json"
REPORT = EXPERIMENT / "reports" / "n30_medium_surface_trace_i5a.md"
ARTIFACT_DIR = EXPERIMENT / "outputs" / "n30_medium_surface_trace_i5a_artifacts"
SCRIPT_RELATIVE_PATH = (
    "experiments/2026-07-N30-lgrc-minimal-shared-medium-participation/scripts/"
    "build_n30_medium_surface_trace_i5a.py"
)
...
N28_I4A2_OUTPUT = N28_ROOT / "outputs" / "n28_generative_mechanism_diversity_probe.json"
N28_REPLAY_OUTPUT = N28_ROOT / "outputs" / "n28_replay_capacity_attribution_matrix.json"
N28_I4A2_ARTIFACT_DIR = (
    N28_ROOT / "outputs" / "n28_generative_mechanism_diversity_probe_artifacts"
)
N28_RUNTIME_TRACE = N28_I4A2_ARTIFACT_DIR / "source_current_runtime_trace.json"
N28_FOCAL_TRACE = N28_I4A2_ARTIFACT_DIR / "focal_basin_stability_trace.json"
N28_NEIGHBOR_TRACE = N28_I4A2_ARTIFACT_DIR / "neighbor_capacity_trace.json"
N28_CAPACITY_ATTRIBUTION_TRACE = N28_I4A2_ARTIFACT_DIR / "capacity_attribution_trace.json"
N28_EXTRACTION_LEAKAGE_TRACE = N28_I4A2_ARTIFACT_DIR / "extraction_leakage_trace.json"
N28_CLASSIFICATION_TRACE = N28_I4A2_ARTIFACT_DIR / "classification_trace.json"
N28_CORE_TRACE = N28_I4A2_ARTIFACT_DIR / "generative_extractive_core.json"
N28_THRESHOLD_TRACE = N28_I4A2_ARTIFACT_DIR / "threshold_policy_trace.json"
N28_REPLAY_TRACE = (
    N28_ROOT
    / "outputs"
    / "n28_replay_capacity_attribution_matrix_artifacts"
    / "n28_i5_replay_n28_i4a2_row_generative_mechanism_diversity_candidate_trace.json"
)
...
def replay_row_for_i4a2(replay_matrix: dict[str, Any]) -> dict[str, Any]:
    for row in replay_matrix.get("replay_rows", replay_matrix.get("candidate_rows", [])):
        if (
            row.get("source_iteration") == "4-A2"
            and row.get("source_role") == "generative_mechanism_diversity"
        ):
            return row
    raise KeyError("N28 I4-A2 generative mechanism-diversity replay row not found")


def build_payload() -> dict[str, Any]:
    i4b = load_json(I4B_OUTPUT)
    i5 = load_json(I5_OUTPUT)
    n28_i4a2 = load_json(N28_I4A2_OUTPUT)
    ...
    replay_row = replay_row_for_i4a2(n28_replay)
    i5_row = i5["candidate_rows"][0]

    focal_basin_id = runtime["focal_basin_id"]
    medium_surface_id = runtime["neighbor_scope_id"]
    participant_event_id = "n30_i5a_n28_i4a2_focal_basin_environment_event"
    perturbation_event_id = "n30_i5a_n28_i4a2_neighbor_surface_perturbation"
    trace_or_surface_change_id = "n30_i5a_n28_i4a2_neighbor_capacity_surface_change"
    relation_chain_id = "n30_i5a_n28_i4a2_focal_to_neighbor_medium_trace_chain"

    medium_surface_declaration = {
        "artifact_role": "medium_surface_declaration_trace",
        "trace_id": "n30_i5a_medium_surface_declaration_trace",
        ...
        "sharedness_argument": (
            "N28 I4-A2 records a split-shell neighbor capacity surface as "
            "distinct from the focal basin and exposes support, boundary, "
            "distinguishability, and environment-capacity fields rather than "
            "private participant state."
        ),
    ...
    participant_medium_separation = {
        ...
        "trace_id": "n30_i5a_participant_medium_separation_trace",
        ...
        "participant_medium_separation_argument": (
            ...
            "the distinct split-shell neighbor capacity surface. The row uses "
            "I4-B as a participant discipline guardrail while the load-bearing "
            "medium trace comes from N28 I4-A2 source-current artifacts."
        ),
    ...
    perturbation_trace = {
        ...
        "trace_id": "n30_i5a_medium_perturbation_trace",
        ...
        "participant_to_medium_causal_closure_status": (
            "not_finalized_until_I6_I7; I5-A records mechanism-diverse "
            "source-current perturbation and surface change, not later "
            "eligibility dependence"
        ),
    }
    ...
    trace_surface_change = {
        ...
        "trace_id": "n30_i5a_trace_or_surface_change",
    ...
    trace_persistence_or_decay = {
        ...
        "trace_id": "n30_i5a_trace_persistence_or_decay",
        "trace_or_surface_change_id": trace_or_surface_change_id,
        ...
        "decay_curve_status": "not_measured_in_I5_A",
        "i6_requirement": (
    ...
    medium_debt_record = {
        ...
        "trace_id": "n30_i5a_medium_debt_record",
        ...
        "remaining_debt": [
            ...
            "decay curve not measured in I5-A",
    ...
    medium_leakage_guard = {
        "artifact_role": "i5a_medium_leakage_guard_trace",
        "trace_id": "n30_i5a_medium_leakage_guard_trace",
    ...
    n30_relation_controls = {
        ...
        "classification": "not_run_for_I5_A_C4_surface_trace_admission",
    ...
    scope_classification = {
        "artifact_role": "i5a_scope_classification",
        "trace_id": "n30_i5a_scope_classification",
    ...
    i5_change_fields = i5_row["trace_or_surface_change"]["surface_change_fields"]
    i5a_change_fields = trace_surface_change["surface_change_fields"]
    i5a_vs_i5_comparison = {
        "artifact_role": "i5a_vs_i5_medium_trace_comparison",
        "trace_id": "n30_i5a_vs_i5_medium_trace_comparison",
        "i5_source_output": rel(I5_OUTPUT),
        "i5_source_output_digest": i5["output_digest"],
        "i5_primary_medium_surface_id": i5["medium_surface_id"],
        "i5a_medium_surface_id": medium_surface_id,
        "i5_mechanism": "single_neighbor_capacity_shell_strengthening",
        "i5a_mechanism": runtime["mechanism_class"],
        "mechanism_distinction_from_i5": (
            "I5 consumes the N28 I4-A single-shell strengthening source. I5-A "
            "consumes the N28 I4-A2 split-shell / delayed-boundary mechanism "
            "source."
        ),
        "source_mechanism_note": runtime["mechanism_distinction_from_i4a"],
        "i5_replaced": False,
        "i5a_replaces_i5": False,
        "i5a_strengthens_i5": True,
        "strengthening_kind": (
            "mechanism_diversity_and_repeatability; I5-A shows that M1 "
            "surface-trace evidence is not confined to the I5 single-shell "
            "strengthening mechanism"
        ),
        "margin_upgrade_claimed": False,
        "delta_comparison": {
            "i5_surface_change_fields": i5_change_fields,
            "i5a_surface_change_fields": i5a_change_fields,
            "i5a_has_larger_all_deltas": all(
                i5a_change_fields[key] > i5_change_fields[key]
                for key in i5a_change_fields
            ),
        },
        "claim_boundary": (
            "I5-A strengthens I5 as a second source-current medium-surface "
            "trace mechanism. It does not replace I5, widen M1 into M2, or "
            "support minimal shared-medium participation."
        ),
    }
    i5a_vs_i5_comparison["comparison_digest"] = digest_value(i5a_vs_i5_comparison)
    ...
    artifacts = [
        ...
        write_artifact("i5a_medium_leakage_guard_trace.json", medium_leakage_guard),
        write_artifact("i5a_scope_classification.json", scope_classification),
        write_artifact("i5a_vs_i5_medium_trace_comparison.json", i5a_vs_i5_comparison),
    ]
    ...
    source_current_inputs = [
        ...
        source_input(I5_OUTPUT, "N30_I5_primary_medium_surface_trace_reference"),
        source_input(
            N28_I4A2_OUTPUT,
            "N28_I4A2_source_current_generative_mechanism_diversity_candidate",
        ),
        source_input(N28_REPLAY_OUTPUT, "N28_replay_capacity_attribution_matrix"),
        source_input(N28_RUNTIME_TRACE, "N28_I4A2_source_current_runtime_trace"),
        source_input(N28_FOCAL_TRACE, "N28_I4A2_focal_basin_stability_trace"),
        source_input(N28_NEIGHBOR_TRACE, "N28_I4A2_neighbor_capacity_medium_surface_trace"),
        source_input(N28_CAPACITY_ATTRIBUTION_TRACE, "N28_I4A2_capacity_attribution_trace"),
        source_input(N28_EXTRACTION_LEAKAGE_TRACE, "N28_I4A2_extraction_leakage_guard_trace"),
        source_input(N28_CLASSIFICATION_TRACE, "N28_I4A2_classification_trace"),
        source_input(N28_CORE_TRACE, "N28_I4A2_generative_extractive_core"),
        source_input(N28_THRESHOLD_TRACE, "N28_I4A2_threshold_policy_trace"),
        source_input(N28_REPLAY_TRACE, "N28_I4A2_replay_trace"),
    ]

    row = {
        "row_id": "n30_i5a_row_01_n28_i4a2_mechanism_diverse_medium_surface_trace_candidate",
        ...
        "participant_persistence_window": [
            "N28_I4A2_step_0_focal_state",
            "N28_I4A2_step_1_focal_state",
            "N28_I5_replay_trace",
        ],
        ...
        "i5a_surface_trace_guardrail_control_ids": surface_trace_guardrail_control_ids,
        ...
        "i5a_scope_classification": scope_classification,
        "i5a_vs_i5_comparison": i5a_vs_i5_comparison,
        "i5_replaced": False,
        "i5a_replaces_i5": False,
        "i5a_strengthens_i5": True,
        "strengthening_role": "mechanism_diverse_M1_strengthening_not_margin_upgrade",
        ...
        "n30_relation_controls": n30_relation_controls,
        "claim_ceiling": (
            "N30-C4 mechanism-diverse medium perturbation / trace candidate "
            "only; no later eligibility dependency, minimal shared-medium "
            "participation, shared-medium coordination, or native "
    ...
    payload: dict[str, Any] = {
        ...
        "iteration": "5-A_mechanism_diverse_medium_surface_trace_strengthening",
        ...
        "source_n28_i4a2_output_digest": n28_i4a2["output_digest"],
        ...
        "source_guardrail_records": {
            ...
            "i5_primary_medium_surface_trace_output_digest": i5["output_digest"],
            "n28_i4a2_source_output_digest": n28_i4a2["output_digest"],
        ...
        "positive_evidence_scope": "mechanism_diverse_medium_surface_perturbation_trace_strengthening_only",
        "i5_replaced": False,
        "i5a_replaces_i5": False,
        "i5a_strengthens_i5": True,
    ...
    checks = [
        ...
        {
            "check_id": "n28_i4a2_source_current_artifacts_consumed_not_closeout_only",
        ...
        {
            "check_id": "i5a_scope_classification_preserves_inherited_runtime_boundary",
        ...
        {
            "check_id": "i4b_p4_guardrail_does_not_promote_i5a_row_participant_rung",
            "passed": payload["strongest_N30_I5A_row_participant_rung"]
            == "P2_candidate"
            and payload["source_i4b_strongest_participant_guardrail"]
            == "P4_candidate",
        },
        {
            "check_id": "i5a_strengthens_i5_without_replacing_it",
            "passed": payload["i5a_strengthens_i5"] is True
            and payload["i5a_replaces_i5"] is False
            and i5a_vs_i5_comparison["margin_upgrade_claimed"] is False,
        },
        {
        ...
        {
            "check_id": "i5a_ceiling_guard_preserved",
...
def write_report(payload: dict[str, Any]) -> None:
    ...
    text = f"""# N30 Iteration 5-A - Mechanism-Diverse Medium Surface Trace
...
strongest_N30_I5A_row_participant_rung = {payload['strongest_N30_I5A_row_participant_rung']}
...
i5_replaced = false
i5a_strengthens_i5 = true
strengthening_kind = {payload['i5a_strengthening_kind']}
margin_upgrade_claimed = false
```
...
```text
i5a_positive_scope = {payload['i5a_scope_classification']['i5a_positive_scope']}
i5a_claim_type = {payload['i5a_claim_type']}
supports_N30_C4 = true
supports_N30_C5 = false
supports_M1 = true
supports_M2 = false
n28_controls_classified_as = {payload['i5a_scope_classification']['n28_controls_classified_as']}
trace_dependency_control_ids = pending_iteration_7
